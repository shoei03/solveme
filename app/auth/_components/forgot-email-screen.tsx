...
export const ForgotEmailScreen: React.FC<ForgotEmailScreenProps> = ({
  onGoBack,
}) => {
      ...
      [
        {
          ...
          onPress: () => {
            Linking.openURL(
              "mailto:support@solveme.app?subject=メールアドレス復旧について&body=メールアドレスを忘れてしまいました。復旧をお願いします。%0A%0A登録時に使用した可能性のある情報：%0A・氏名：%0A・電話番号：%0A・その他の情報："
            );
          },
        },
